...
public record SongCreateRequest(@NotBlank(message = "곡 제목은 필수입니다") @Size(max = 200) String title,
		...
		@Size(max = 100) String externalTrackId, @Size(max = 500) String artworkUrl,
		@Size(max = 2000, message = "메모는 2000자 이내여야 합니다") String memo, @Size(max = 500) String referenceVideoUrl,
