 ...
 * @param limit 검색 결과 최대 개수 (iTunes 최대 200). 프론트 "곡 검색" 모달이 스크롤 가능한 리스트로 전부 보여준다 — 너무 키우면
 * 관련 없는 결과(리믹스·커버 등)가 섞여 노이즈만 늘어난다.
...
public record MusicProperties(@DefaultValue("stub") String provider, @DefaultValue("25") int limit,
