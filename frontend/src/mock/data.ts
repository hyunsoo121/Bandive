...
export const SONGS: Song[] = [
  {
    ...
    sourceType: 'SEARCH',
    proposer: '윤수빈',
    memo: '인트로 신스는 건반으로 대체. 2절 후 브릿지 4마디 늘려서 기타 솔로.',
  ...
  },
  {
    ...
    sourceType: 'SEARCH',
    proposer: '김시훈',
    memo: '기타 크런치 톤 세팅 필요. 후반 샤우팅 파트 논의.',
